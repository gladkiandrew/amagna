 ...
 * gold — luminous vertical streaks running briskly DOWN the page (~7s per
 * pass) through a meander of soft glow-pools that trace the river's course
 * right-of-center, with a faint counter-strand on the far left. Deliberately
 * bolder than a wash: the streaks are meant to be SEEN. Content floats over
 * the layer and the current glows through the whitespace, so reading
 * contrast on the cream canvas is never touched.
 *
 ...
 *
 * `seam` renders the horizon transition at the top: one short downward fade
 * from the ocean's own bottom-row navy through gray into the cream. In-flow,
 * so content below always starts on clean canvas.
 */
...
const STREAKS: readonly Streak[] = [
  ...
  { left: '71%', top: '0%', color: 'purple', dur: 6.8, delay: -1.2, peak: 0.85 },
  { left: '78%', top: '5%', color: 'gold', dur: 8.4, delay: -4.2, peak: 0.9, h: '56vh' },
  { left: '84%', top: '10%', color: 'purple', dur: 6, delay: -2.4, peak: 0.8 },
  { left: '88%', top: '15%', color: 'gold', dur: 7.2, delay: -0.4, peak: 0.75, h: '38vh' },
  { left: '73%', top: '20%', color: 'gold', dur: 7.6, delay: -6, peak: 0.85 },
  { left: '69%', top: '25%', color: 'purple', dur: 6.4, delay: -3.2, peak: 0.8, h: '52vh' },
  { left: '76%', top: '30%', color: 'purple', dur: 8.8, delay: -3.6, peak: 0.9, h: '58vh' },
  { left: '83%', top: '35%', color: 'gold', dur: 6.4, delay: -0.8, peak: 0.8 },
  { left: '87%', top: '40%', color: 'purple', dur: 7.2, delay: -5.6, peak: 0.75, h: '42vh' },
  { left: '79%', top: '45%', color: 'gold', dur: 8, delay: -6.8, peak: 0.85, h: '50vh' },
  { left: '72%', top: '50%', color: 'purple', dur: 6.8, delay: -2.2, peak: 0.8 },
  { left: '76%', top: '55%', color: 'gold', dur: 7.6, delay: -5.2, peak: 0.9, h: '54vh' },
  { left: '84%', top: '60%', color: 'purple', dur: 8.4, delay: -1.4, peak: 0.8, h: '44vh' },
  { left: '88%', top: '65%', color: 'gold', dur: 6.8, delay: -3.8, peak: 0.75 },
  { left: '80%', top: '70%', color: 'purple', dur: 7.2, delay: -6.2, peak: 0.85, h: '52vh' },
  { left: '74%', top: '75%', color: 'gold', dur: 8, delay: -2.8, peak: 0.9 },
  { left: '70%', top: '80%', color: 'purple', dur: 6.4, delay: -4.6, peak: 0.8, h: '46vh' },
  { left: '77%', top: '85%', color: 'gold', dur: 7.6, delay: -1.8, peak: 0.85, h: '50vh' },
  { left: '83%', top: '90%', color: 'purple', dur: 6.8, delay: -5.4, peak: 0.8 },
  { left: '79%', top: '95%', color: 'gold', dur: 7.2, delay: -3.4, peak: 0.85, h: '44vh' },
  // counter-strand — quiet balance on the far left
  { left: '6%', top: '8%', color: 'gold', dur: 9.2, delay: -3.8, peak: 0.55 },
  { left: '10%', top: '28%', color: 'purple', dur: 8, delay: -6.6, peak: 0.55, h: '38vh' },
  { left: '5%', top: '48%', color: 'purple', dur: 8.8, delay: -1.6, peak: 0.5 },
  { left: '11%', top: '68%', color: 'gold', dur: 7.6, delay: -4.8, peak: 0.55, h: '40vh' },
  { left: '7%', top: '88%', color: 'purple', dur: 8.4, delay: -3, peak: 0.5, h: '36vh' },
] as const;
