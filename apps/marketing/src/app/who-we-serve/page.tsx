...
const BOXES: ServeBox[] = [
  {
    href: '/home-services',
    name: 'Home Services',
    hook: 'Predictable, owned jobs instead of feast-or-famine.',
    points: [
      'Local lead funnels that fill the slow months',
      'Get found on Google + reviews on autopilot',
      'Follow-up that never lets a job slip',
    ],
  ...
  {
    href: '/real-estate',
    name: 'Real Estate Agents, Developers & PE',
    hook: 'Stay top of mind and fill the pipeline — agents, teams, developers, and real-estate PE.',
    points: [
      'Daily content + sphere nurture in your voice',
      'Listing-intent funnels, not buyer noise',
      'One brain across agents and portfolios',
    ],
    cta: 'Chart this course',
  ...
  },
  {
    ...
    hook: 'A full schedule of the right patients, handled compliantly.',
    points: [
      'Targeted acquisition for high-value services',
      'Reviews + reminders that cut no-shows',
  ...
  },
  {
    ...
    hook: 'Content + ads that turn scrollers into repeat buyers.',
    points: [
      'Always-on creative for Meta & TikTok',
      'Paid acquisition tuned to your margins',
      'Email & SMS flows that drive repeat orders',
    ],
    cta: 'Chart this course',
    accent: 'border-brand-purple/30',
  },
  {
    ...
    hook: 'Consistent marketing across every location, run from one brain.',
    points: [
      'Central brand with local relevance per location',
      'Listings + reviews managed at scale',
      'One roll-up report across the whole group',
    ],
    cta: 'Chart this course',
    accent: 'border-brand-gold/40',
  },
